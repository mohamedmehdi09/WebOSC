...
export default async function EditAnnouncementPage({
  ...
  if (!isEditor) return <div className="text-center text-red-500">You are not allowed to edit this announcement.</div>;
    ...
    <div className="flex flex-col flex-1 gap-8 rounded-lg m-4 md:m-12 p-6 md:p-10 bg-gradient-to-b from-slate-700 to-slate-800 shadow-lg">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 text-base md:text-lg">
          <div className="flex">
            <span className="font-semibold text-gray-300 pr-1">Created At:</span>
            <span>
          ...
          <div className="flex">
            <span className="font-semibold text-gray-300 pr-1">Updated At:</span>
            <span>
